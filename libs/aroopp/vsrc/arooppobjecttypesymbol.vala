...
public abstract class aroopp.ObjectTypeSymbol : TypeSymbol {
	private ArrayList<TypeParameter> type_parameters = new ArrayList<TypeParameter> ();

	public ObjectTypeSymbol (string name, SourceReference? source_reference = null, Comment? comment = null) {
		base (name, source_reference, comment);
	}

	public abstract ArrayList<Method> get_methods ();
	public abstract ArrayList<Signal> get_signals ();
	public abstract ArrayList<Property> get_properties ();
	 ...
	 */
	public ArrayList<TypeParameter> get_type_parameters () {
