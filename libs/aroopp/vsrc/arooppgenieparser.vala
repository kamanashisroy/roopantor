...
public class aroopp.Genie.Parser : CodeVisitor {
	...
	static ArrayList<TypeParameter> _empty_type_parameter_list;
	...
	DataType parse_type (bool owned_by_default = true) throws ParseError {
		...
		ArrayList<DataType> type_arg_list = null;
		UnresolvedSymbol sym = null;
	...
	ArrayList<Expression> parse_argument_list () throws ParseError {
	...
	Expression parse_simple_name () throws ParseError {
		...
		ArrayList<DataType> type_arg_list = parse_type_argument_list (true);
	...
	ArrayList<Expression> parse_print_argument_list () throws ParseError {
		var list = new ArrayList<Expression> ();
		var i = 0;
		var begin = get_location ();
	...
	ArrayList<Expression> parse_expression_list () throws ParseError {
		var list = new ArrayList<Expression> ();
		do {
	...
	Expression parse_array_creation_expression (SourceLocation begin, DataType element_type) throws ParseError {
		...
		ArrayList<Expression> size_specifier_list = null;
		bool first = true;
	...
	ArrayList<MemberInitializer> parse_object_initializer () throws ParseError {
	...
	void parse_catch_clauses (ArrayList<CatchClause> catch_clauses) throws ParseError {
	...
	ArrayList<Attribute>? parse_attributes (bool parameter) throws ParseError {
	...
	void set_attributes (CodeNode node, ArrayList<Attribute>? attributes) {
		if (attributes != null) {
			foreach (Attribute attr in (ArrayList<Attribute>) attributes) {
	...
	Namespace parse_namespace_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	Symbol parse_class_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	Constant parse_constant_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	Field parse_field_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		string id = parse_identifier ();
		expect (TokenType.COLON);
	...
	Method parse_main_method_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var id = "main";
		var begin = get_location ();
		DataType type = new VoidType ();
	...
	Method parse_method_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		DataType type = new VoidType ();
		expect (TokenType.DEF);
		var flags = parse_member_declaration_modifiers ();
	...
	Property parse_property_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		var readonly = false;
	...
	aroopp.Signal parse_signal_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		DataType type;
	...
	Constructor parse_constructor_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	Destructor parse_destructor_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	Symbol parse_struct_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	Symbol parse_interface_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	Symbol parse_enum_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	Symbol parse_errordomain_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	CreationMethod parse_creation_method_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
	...
	Symbol parse_delegate_declaration (ArrayList<Attribute>? attrs) throws ParseError {
		var begin = get_location ();
		DataType type;
	...
	ArrayList<TypeParameter> parse_type_parameter_list () throws ParseError {
	...
	ArrayList<DataType>? parse_type_argument_list (bool maybe_expression) throws ParseError {
		var begin = get_location ();
		if (accept (TokenType.OF)) {
	...
	MemberAccess parse_member_name (Expression? base_expr = null) throws ParseError {
		...
		do {
			string id = parse_identifier ();
			ArrayList<DataType> type_arg_list = parse_type_argument_list (false);
