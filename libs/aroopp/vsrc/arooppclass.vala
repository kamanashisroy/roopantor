...
public class aroopp.Class : ObjectTypeSymbol {
	...
	private ArrayList<DataType> base_types = new ArrayList<DataType> ();
	 ...
	 */
	public ArrayList<Class> get_classes () {
		return classes;
	}
	 ...
	 */
	public ArrayList<Struct> get_structs () {
		return structs;
	}
	 ...
	 */
	public ArrayList<Enum> get_enums () {
		return enums;
	}
	 ...
	 */
	public ArrayList<Delegate> get_delegates () {
		return delegates;
	}
	 ...
	 */
	public ArrayList<DataType> get_base_types () {
		return base_types;
	}
	 ...
	 */
	public override ArrayList<Method> get_methods () {
		return methods;
	}
	 ...
	 */
	public override ArrayList<Property> get_properties () {
		return properties;
	}
	 ...
	 */
	public override ArrayList<Signal> get_signals () {
		return signals;
	}
	...
	private void get_all_prerequisites (Interface iface, ArrayList<TypeSymbol> list) {
	...
	public override bool check (CodeContext context) {
		...
		ArrayList<TypeSymbol> prerequisites = new ArrayList<TypeSymbol> ();
		foreach (DataType base_type in get_base_types ()) {
			if (base_type.data_type is Interface) {
		...
		ArrayList<string> missing_prereqs = new ArrayList<string> ();
