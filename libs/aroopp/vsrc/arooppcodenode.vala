...
public abstract class aroopp.CodeNode {
	...
	private ArrayList<DataType> _error_types;
	private static ArrayList<DataType> _empty_type_list;
	 ...
	 */
	public ArrayList<DataType> get_error_types () { 
	 ...
	 * or a child node 
	 */
	public void add_error_types (ArrayList<DataType> error_types) {
	...
	public virtual void get_defined_variables (Set<Variable> collection) {
	}

	public virtual void get_used_variables (Set<Variable> collection) {
	}
