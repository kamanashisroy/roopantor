 ...
 */
public class aroopp.MarkupReader : Replicable {
	...
	HashTable<string> attributes = new HashTable<string> (str_hash, str_equal);
	bool empty_element;
	 ...
	 */
	public HashTable<string> get_attributes () {
		var result = new HashTable<string> (str_hash, str_equal);
