...
public class aroopp.Scope {
	...
	private HashTable<Symbol> symbol_table;
	private ArrayList<Symbol> anonymous_members;
	...
	public void add (string? name, Symbol sym) {
		if (name != null) {
			if (symbol_table == null) {
				symbol_table = new HashTable<Symbol> (str_hash, str_equal);
	...
	public HashTable<Symbol> get_symbol_table () {
		return symbol_table;
	}
}
