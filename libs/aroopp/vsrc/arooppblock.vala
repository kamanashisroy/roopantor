...
public class aroopp.Block : Symbol, Statement {
	...
	private ArrayList<Statement> statement_list = new ArrayList<Statement> ();
	private ArrayList<LocalVariable> local_variables = new ArrayList<LocalVariable> ();
	private ArrayList<Constant> local_constants = new ArrayList<Constant> ();
	 ...
	 */
	public ArrayList<Statement> get_statements () {
	 ...
	 */
	public ArrayList<LocalVariable> get_local_variables () {
