...
public class aroopp.CodeWriter : CodeVisitor {
	...
	void visit_sorted (ArrayList<Symbol> symbols) {
	...
	private void write_error_domains (ArrayList<DataType> error_domains) {
	...
	private void write_params (ArrayList<Parameter> params) {
		write_string ("(");
	...
	void write_type_parameters (ArrayList<TypeParameter> type_params) {
