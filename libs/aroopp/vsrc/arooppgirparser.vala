...
public class aroopp.GirParser : CodeVisitor {
	...
	class Node {
		...
		public string name;
		public HashTable<string> girdata = null;
		...
		public HashTable<ArrayList<Node>> scope = new HashTable<ArrayList<Node>> (str_hash, str_equal);
	...
	void process_callable (Node node) {
		var s = node.symbol;
		ArrayList<ParameterInfo> parameters = node.parameters;
