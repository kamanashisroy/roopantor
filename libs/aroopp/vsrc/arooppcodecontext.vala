...
public class aroopp.CodeContext {
	...
	/**
	 * ArrayList of directories where to find .vapi files.
	 */
	public string[] vapi_directories;

	/**
	 * ArrayList of directories where to find .gir files.
	 */
	public string[] gir_directories;

	/**
	 * ArrayList of directories where to find .metadata files for .gir files.
	 */
	...
	private ArrayList<SourceFile> source_files = new ArrayList<SourceFile> ();
	private ArrayList<string> c_source_files = new ArrayList<string> ();
	private Namespace _root = new Namespace (null);

	private ArrayList<string> packages = new ArrayList<string> (str_equal);
	 ...
	 */
	public ArrayList<SourceFile> get_source_files () {
		return source_files;
	}
	 ...
	 */
	public ArrayList<string> get_c_source_files () {
	 ...
	 */
	public ArrayList<string> get_packages () {
		return packages;
	}
