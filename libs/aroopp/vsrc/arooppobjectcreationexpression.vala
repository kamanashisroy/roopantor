...
public class aroopp.ObjectCreationExpression : Expression {
	...
	private ArrayList<Expression> argument_list = new ArrayList<Expression> ();

	private ArrayList<MemberInitializer> object_initializer = new ArrayList<MemberInitializer> ();
	 ...
	 */
	public ArrayList<Expression> get_argument_list () {
	 ...
	 */
	public ArrayList<MemberInitializer> get_object_initializer () {
