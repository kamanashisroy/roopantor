...
public class aroopp.BasicBlock {
	private ArrayList<CodeNode> nodes = new ArrayList<CodeNode> ();

	// control flow graph
	private ArrayList<weak BasicBlock> predecessors = new ArrayList<weak BasicBlock> ();
	...
	public ArrayList<CodeNode> get_nodes () {
		return nodes;
	}
	...
	public ArrayList<weak BasicBlock> get_predecessors () {
		return predecessors;
	}

	public ArrayList<weak BasicBlock> get_successors () {
		return successors;
	}
	...
	public ArrayList<BasicBlock> get_children () {
		return children;
	}
