...
public class aroopp.ForStatement : CodeNode, Statement {
	...
	private ArrayList<Expression> initializer = new ArrayList<Expression> ();
	private ArrayList<Expression> iterator = new ArrayList<Expression> ();
	 ...
	 */
	public ArrayList<Expression> get_initializer () {
		return initializer;
	}
	 ...
	 * @return iterator
	 */
	public ArrayList<Expression> get_iterator () {
		return iterator;
	}
