...
public class aroopp.ArrayCreationExpression : Expression {
	 ...
	 */
	public ArrayList<Expression> get_sizes () {
		return sizes;
	}
	...
	private int create_sizes_from_initializer_list (CodeContext context, InitializerList il, int rank, ArrayList<Literal> sl) {
	...
	public override bool check (CodeContext context) {
		...
		ArrayList<Expression> sizes = get_sizes ();
