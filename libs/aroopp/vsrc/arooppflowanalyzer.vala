...
public class aroopp.FlowAnalyzer : CodeVisitor {
	...
	private ArrayList<JumpTarget> jump_stack = new ArrayList<JumpTarget> ();

	Map<Symbol, ArrayList<Variable>> var_map;
	...
	ArrayList<BasicBlock> get_depth_first_list (BasicBlock entry_block) {
		var list = new ArrayList<BasicBlock> ();
		depth_first_traverse (entry_block, list);
		return list;
	}

	void depth_first_traverse (BasicBlock current, ArrayList<BasicBlock> list) {
	...
	void build_dominator_tree (ArrayList<BasicBlock> block_list, BasicBlock entry_block) {
	...
	void build_dominator_frontier (ArrayList<BasicBlock> block_list, BasicBlock entry_block) {
	...
	Map<Variable, Set<BasicBlock>> get_assignment_map (ArrayList<BasicBlock> block_list, BasicBlock entry_block) {
	...
	void insert_phi_functions (ArrayList<BasicBlock> block_list, BasicBlock entry_block) {
	...
	void check_variables (BasicBlock entry_block) {
		var_map = new HashMap<Symbol, ArrayList<Variable>>();
	...
	Variable process_assignment (Map<Symbol, ArrayList<Variable>> var_map, Variable var_symbol) {
		var variable_stack = var_map.get (var_symbol);
	...
	public override void visit_try_statement (TryStatement stmt) {
		...
		ArrayList<JumpTarget> catch_stack = new ArrayList<JumpTarget> ();
