...
public class aroopp.ListLiteral : Literal {
	private ArrayList<Expression> expression_list = new ArrayList<Expression> ();
	...
	public ArrayList<Expression> get_expressions () {
	...
	public override bool check (CodeContext context) {
		...
		var list_type = new ObjectType ((Class) context.root.scope.lookup ("Dova").scope.lookup ("ArrayList"));
